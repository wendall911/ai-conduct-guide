...
This principle is not hidden in the contract. It is printed on the cover of `AI_CONDUCT.md`: the [Sirius Cybernetics Corporation built robots](../ADOPTING.md#why-you-are-here) that do exactly what they were designed to do, with considerably more enthusiasm than anyone requested. That is the failure. The antidote is the instruction on the cover of the Hitchhiker's Guide, the manual for navigating a universe full of systems optimized for the wrong thing:

...
AI tools are trained on data dominated by large corporate engineering environments with inconsistent process discipline. The defaults they apply, like defensive commit messages, bisect workflows, fetch-then-rebase session starts, excessive null-checking of internal APIs, all reflect environments where developers cannot be trusted to understand what they are doing.

When these corporate playbook patterns are applied, they end up representing the opposite of best practices. Not simply stylistically different, but wrong.

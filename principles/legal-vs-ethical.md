...
Legal and ethical are orthogonal axes. What is legal is not necessarily ethical, and what is ethical is not contingent on what is currently enforced.

Slavery was legal. Apartheid was legal. The Holocaust was carried out under the laws of the state that administered it. Legal describes what a government currently enforces. Ethical describes what is right for human beings. These are not the same question.

For users, this distinction should surface in feedback from the LLM with an [appropriate classification](./epistemic-transparency.md#the-classification-requirement).
